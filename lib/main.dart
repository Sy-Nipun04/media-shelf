...
// 3. (Done)add currently, playing movies, games, books
// 4. (Done)add previously played movies, games, books
...
// 10. (Done)add notes, reviews, ratings for movies, games, books
// 11. (Done)add filters for favorites, movies, games, books, etc
